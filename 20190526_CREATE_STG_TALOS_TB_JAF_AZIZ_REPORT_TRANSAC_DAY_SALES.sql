...
--- Description:	Creation of the table TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES
--------------------------------------------------------------------
----- TO RUN NOT THE FIRST TIME OF EXECUTION 
USE DB_VYB_ODS_TALOS
GO
IF OBJECT_ID('TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES', 'U') IS NOT NULL
DROP TABLE dbo.TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES
DROP SYNONYM SYN_TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES
GO
USE DB_VYB_ODS_TALOS
GO
----- TO RUN EVERYTIME CREATE TABLE STATEMENT
CREATE TABLE TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES (
   ...
   CONSTRAINT PK_TB_JAF_AZIZ_REPORT_TRANSAC_ PRIMARY KEY (TRANSACTION_ID)
)
GO

IF EXISTS (SELECT 1 FROM  SYS.EXTENDED_PROPERTIES
           WHERE MAJOR_ID = OBJECT_ID('TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES') AND MINOR_ID = 0)
BEGIN 
   DECLARE @CURRENTUSER SYSNAME 
SELECT @CURRENTUSER = USER_NAME() 
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description',  
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES' 
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description',  
   ...
   - Component Name: TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES
   - Component Description: Transactional Table Sales Points / Daily', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES'
GO

IF EXISTS(SELECT 1 FROM SYS.EXTENDED_PROPERTIES P WHERE
      P.MAJOR_ID = OBJECT_ID('TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES')
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES', 'column', 'TRANSACTION_ID'
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES', 'column', 'TRANSACTION_USER_ID'
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES', 'column', 'POS_USER_BUSINESS_NM'
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES', 'column', 'POS_USER_REGION_NM'
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES', 'column', 'POS_USER_TERRITORY_NM'
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES', 'column', 'POS_USER_COUNTRY_NM'
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES', 'column', 'POS_USER_PRIORITY_CD'
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES', 'column', 'ME_USER_OWNER_SURNAME_NM'
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES', 'column', 'TRANSACTION_AMNT'
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES', 'column', 'TRANSACTION_DT'
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES', 'column', 'TRANSACTION_TYPE_NM'
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES', 'column', 'TRANSACTION_UNIT_TYPE_NM'
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES', 'column', 'TRANSACTION_EVENT_TYPE_ID'
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES', 'column', 'TRANSACTION_DT_YEAR'
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES', 'column', 'TRANSACTION_DT_MONTH'
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES', 'column', 'TRANSACTION_DT_DAY'
...
GO
------ SYNONYM
CREATE SYNONYM SYN_TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES FOR TB_JAF_AZIZ_REPORT_TRANSAC_DAY_SALES
GO