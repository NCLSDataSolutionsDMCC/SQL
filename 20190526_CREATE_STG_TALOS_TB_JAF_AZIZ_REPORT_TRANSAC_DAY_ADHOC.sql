...
--- Description:	Creation of the table TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC
--------------------------------------------------------------------
----- TO RUN NOT THE FIRST TIME OF EXECUTION 
USE DB_VYB_ODS_TALOS
GO
IF OBJECT_ID('TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC', 'U') IS NOT NULL
DROP TABLE dbo.TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC
DROP SYNONYM SYN_TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC
GO
USE DB_VYB_ODS_TALOS
GO
----- TO RUN EVERYTIME CREATE TABLE STATEMENT
CREATE TABLE TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC (
   ...
   CONSTRAINT PK_TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC PRIMARY KEY (TRANSACTION_ID)
)
GO
IF EXISTS (SELECT 1 FROM  SYS.EXTENDED_PROPERTIES
           WHERE MAJOR_ID = OBJECT_ID('TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC') AND MINOR_ID = 0)
BEGIN 
   DECLARE @CURRENTUSER SYSNAME 
SELECT @CURRENTUSER = USER_NAME() 
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description',  
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC' 
END 
SELECT @CURRENTUSER = USER_NAME() 
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description',  
   ...
   - Component Name: TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC
   - Component Description: Transactional Table Sales Points / Daily', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC'
GO
IF EXISTS(SELECT 1 FROM SYS.EXTENDED_PROPERTIES P WHERE
      P.MAJOR_ID = OBJECT_ID('TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC')
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC', 'column', 'TRANSACTION_ID'
END
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC', 'column', 'TRANSACTION_USER_ID'
END
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC', 'column', 'POS_USER_BUSINESS_NM'
END
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   'User Business Name',
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC', 'column', 'POS_USER_REGION_NM'
END
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC', 'column', 'POS_USER_TERRITORY_NM'
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC', 'column', 'POS_USER_COUNTRY_NM'
END
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC', 'column', 'POS_USER_PRIORITY_CD'
END
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   'User Priority Code',
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC', 'column', 'ME_USER_OWNER_SURNAME_NM'
END
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   'User Surname Name',
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC', 'column', 'TRANSACTION_AMNT'
END
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   'Transaction Amount',
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC', 'column', 'TRANSACTION_DT'
END
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   'Transaction Date',
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC', 'column', 'TRANSACTION_TYPE_NM'
END
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC', 'column', 'TRANSACTION_UNIT_TYPE_NM'
END
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   'Event Identifier',
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC', 'column', 'TRANSACTION_EVENT_TYPE_ID'
END
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC', 'column', 'TRANSACTION_DT_YEAR'
END
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC', 'column', 'TRANSACTION_DT_MONTH'
...
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_DROPEXTENDEDPROPERTY 'MS_Description', 
   'user', @CURRENTUSER, 'table', 'TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC', 'column', 'TRANSACTION_DT_DAY'
END
SELECT @CURRENTUSER = USER_NAME()
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
...
GO
------ SYNONYM
CREATE SYNONYM SYN_TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC FOR TB_JAF_AZIZ_REPORT_TRANSAC_DAY_ADHOC
GO